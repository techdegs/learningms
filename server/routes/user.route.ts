...
import { activateUser, fetchAllUsers, getUserInfo, loginUser, logoutUser, registerUser, socialAuth, updateAccessToken, updatePassword, updateProfilePicture, updateUserInfo } from '../controllers/user.controller'
...
userRouter.get('/all-users', isAuthenticated, authorizeRoles("admin"), fetchAllUsers);
